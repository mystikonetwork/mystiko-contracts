...
export interface MystikoVerifierPoolInterface extends utils.Interface {
  contractName: 'MystikoVerifierPool';
  functions: {
...
export interface MystikoVerifierPool extends BaseContract {
  contractName: 'MystikoVerifierPool';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MystikoVerifierPoolInterface;
