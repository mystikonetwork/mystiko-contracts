...
export type CallSaltEvent = TypedEvent<[string, string], { id: string; salt: string }>;
...
export interface TimelockController extends BaseContract {
  ...
  estimateGas: {
    ...
    cancel(id: BytesLike, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
