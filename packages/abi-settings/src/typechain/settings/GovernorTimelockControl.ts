...
export type ProposalExecutedEvent = TypedEvent<[BigNumber], { proposalId: BigNumber }>;

export type ProposalExecutedEventFilter = TypedEventFilter<ProposalExecutedEvent>;

export type ProposalQueuedEvent = TypedEvent<
  [BigNumber, BigNumber],
  { proposalId: BigNumber; etaSeconds: BigNumber }
>;

export type ProposalQueuedEventFilter = TypedEventFilter<ProposalQueuedEvent>;

export type TimelockChangeEvent = TypedEvent<[string, string], { oldTimelock: string; newTimelock: string }>;
