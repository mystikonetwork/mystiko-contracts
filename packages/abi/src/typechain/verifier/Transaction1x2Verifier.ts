...
export interface Transaction1x2VerifierInterface extends utils.Interface {
  contractName: 'Transaction1x2Verifier';
  functions: {
...
export interface Transaction1x2Verifier extends BaseContract {
  contractName: 'Transaction1x2Verifier';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Transaction1x2VerifierInterface;
