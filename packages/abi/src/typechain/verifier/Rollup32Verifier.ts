...
export interface Rollup32VerifierInterface extends utils.Interface {
  contractName: "Rollup32Verifier";
  functions: {
...
export interface Rollup32Verifier extends BaseContract {
  contractName: "Rollup32Verifier";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Rollup32VerifierInterface;
