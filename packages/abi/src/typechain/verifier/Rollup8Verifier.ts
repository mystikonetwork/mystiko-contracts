...
export interface Rollup8VerifierInterface extends utils.Interface {
  contractName: "Rollup8Verifier";
  functions: {
...
export interface Rollup8Verifier extends BaseContract {
  contractName: "Rollup8Verifier";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Rollup8VerifierInterface;
