...
export interface Transaction1x0VerifierInterface extends utils.Interface {
  contractName: 'Transaction1x0Verifier';
  functions: {
...
export interface Transaction1x0Verifier extends BaseContract {
  contractName: 'Transaction1x0Verifier';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Transaction1x0VerifierInterface;
