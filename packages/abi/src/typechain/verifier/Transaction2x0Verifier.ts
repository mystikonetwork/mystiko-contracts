...
export interface Transaction2x0VerifierInterface extends utils.Interface {
  contractName: "Transaction2x0Verifier";
  functions: {
...
export interface Transaction2x0Verifier extends BaseContract {
  contractName: "Transaction2x0Verifier";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Transaction2x0VerifierInterface;
