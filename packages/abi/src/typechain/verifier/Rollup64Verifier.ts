...
export interface Rollup64VerifierInterface extends utils.Interface {
  contractName: "Rollup64Verifier";
  functions: {
...
export interface Rollup64Verifier extends BaseContract {
  contractName: "Rollup64Verifier";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Rollup64VerifierInterface;
