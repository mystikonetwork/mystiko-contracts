...
export interface Rollup2VerifierInterface extends utils.Interface {
  contractName: "Rollup2Verifier";
  functions: {
...
export interface Rollup2Verifier extends BaseContract {
  contractName: "Rollup2Verifier";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Rollup2VerifierInterface;
