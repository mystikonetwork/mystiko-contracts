...
import type { IWormholeRelayer, IWormholeRelayerInterface } from '../IWormholeRelayer';
...
export class IWormholeRelayer__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): IWormholeRelayer {
