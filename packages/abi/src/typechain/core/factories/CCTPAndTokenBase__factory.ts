...
import type { CCTPAndTokenBase, CCTPAndTokenBaseInterface } from '../CCTPAndTokenBase';
...
export class CCTPAndTokenBase__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): CCTPAndTokenBase {
