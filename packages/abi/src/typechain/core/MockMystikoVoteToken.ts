...
export interface MockMystikoVoteTokenInterface extends utils.Interface {
  contractName: 'MockMystikoVoteToken';
  functions: {
...
export type DelegateVotesChangedEvent = TypedEvent<
  ...
  { delegate: string; previousVotes: BigNumber; newVotes: BigNumber }
>;
...
export interface MockMystikoVoteToken extends BaseContract {
  contractName: 'MockMystikoVoteToken';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockMystikoVoteTokenInterface;
