...
export interface IMystikoAuditorPoolInterface extends utils.Interface {
  contractName: 'IMystikoAuditorPool';
  functions: {
...
export interface IMystikoAuditorPool extends BaseContract {
  contractName: 'IMystikoAuditorPool';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IMystikoAuditorPoolInterface;
