...
export interface IWormholeRelayerInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [BigNumberish, string, BytesLike, BigNumberish, BigNumberish, BigNumberish, string],
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [BigNumberish, string, BytesLike, BigNumberish, BigNumberish, VaaKeyStruct[]],
  ): string;
  ...
  decodeFunctionResult(functionFragment: 'sendPayloadToEvm', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'sendToEvm', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'sendVaasToEvm', data: BytesLike): Result;
...
export interface IWormholeRelayer extends BaseContract {
  ...
  functions: {
    ...
    getDefaultDeliveryProvider(overrides?: CallOverrides): Promise<[string] & { deliveryProvider: string }>;
