...
export interface MystikoVerifierRegistryInterface extends utils.Interface {
  contractName: 'MystikoVerifierRegistry';
  functions: {
...
export type RollupVerifierEnabledEvent = TypedEvent<
  [number, string],
  { rollupSize: number; verifier: string }
>;
...
export type TransactVerifierEnabledEvent = TypedEvent<
  ...
  { inputNumber: number; outputNumber: number; verifier: string }
>;
