...
export interface MystikoTBridgeProxyInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "addExecutorWhitelist",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "addRegisterWhitelist",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "removeExecutorWhitelist",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "removeRegisterWhitelist",
    values: [string]
  ): string;
  encodeFunctionData(
