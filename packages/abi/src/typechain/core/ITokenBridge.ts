...
export declare namespace ITokenBridge {
  ...
  export type TransferStructOutput = [number, BigNumber, string, number, string, number, BigNumber] & {
    payloadID: number;
    amount: BigNumber;
    tokenAddress: string;
    tokenChain: number;
  ...
  export type AssetMetaStructOutput = [number, string, number, number, string, string] & {
    payloadID: number;
    tokenAddress: string;
    tokenChain: number;
    decimals: number;
  ...
  export type RecoverChainIdStructOutput = [string, number, BigNumber, number] & {
    module: string;
    action: number;
  ...
  export type RegisterChainStructOutput = [string, number, number, number, string] & {
    module: string;
    action: number;
    chainId: number;
...
export interface ITokenBridgeInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'attestToken', values: [string, BigNumberish]): string;
  ...
  encodeFunctionData(functionFragment: 'encodeAssetMeta', values: [ITokenBridge.AssetMetaStruct]): string;
  encodeFunctionData(functionFragment: 'encodeTransfer', values: [ITokenBridge.TransferStruct]): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: 'outstandingBridged', values: [string]): string;
  ...
  encodeFunctionData(
    ...
    values: [string, BigNumberish, BigNumberish, BytesLike, BigNumberish, BigNumberish],
  ): string;
  encodeFunctionData(
...
export type TransferRedeemedEvent = TypedEvent<
  ...
  { emitterChainId: number; emitterAddress: string; sequence: BigNumber }
>;
...
export interface ITokenBridge extends BaseContract {
  ...
  encodeAssetMeta(meta: ITokenBridge.AssetMetaStruct, overrides?: CallOverrides): Promise<string>;

  encodeTransfer(transfer: ITokenBridge.TransferStruct, overrides?: CallOverrides): Promise<string>;
  ...
  parseAssetMeta(encoded: BytesLike, overrides?: CallOverrides): Promise<ITokenBridge.AssetMetaStructOutput>;
  ...
  parseTransfer(encoded: BytesLike, overrides?: CallOverrides): Promise<ITokenBridge.TransferStructOutput>;
  ...
  filters: {
    ...
    'TransferRedeemed(uint16,bytes32,uint64)'(
      emitterChainId?: BigNumberish | null,
      emitterAddress?: BytesLike | null,
  ...
  estimateGas: {
    ...
    encodeAssetMeta(meta: ITokenBridge.AssetMetaStruct, overrides?: CallOverrides): Promise<BigNumber>;

    encodeTransfer(transfer: ITokenBridge.TransferStruct, overrides?: CallOverrides): Promise<BigNumber>;
