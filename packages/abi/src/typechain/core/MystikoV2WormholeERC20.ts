...
export interface MystikoV2WormholeERC20Interface extends utils.Interface {
  contractName: 'MystikoV2WormholeERC20';
  functions: {
...
export interface MystikoV2WormholeERC20 extends BaseContract {
  contractName: 'MystikoV2WormholeERC20';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MystikoV2WormholeERC20Interface;
