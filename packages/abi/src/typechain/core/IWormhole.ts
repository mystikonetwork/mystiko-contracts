...
export declare namespace IWormhole {
  ...
  export type SetMessageFeeStructOutput = [string, number, number, BigNumber] & {
    module: string;
    action: number;
    chain: number;
  ...
  export type TransferFeesStructOutput = [string, number, number, BigNumber, string] & {
    module: string;
    action: number;
    chain: number;
    amount: BigNumber;
...
export interface IWormholeInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [BytesLike, IWormhole.SignatureStruct[], IWormhole.GuardianSetStruct],
  ): string;
  encodeFunctionData(functionFragment: 'verifyVM', values: [IWormhole.VMStruct]): string;
...
export type GuardianSetAddedEvent = TypedEvent<[number], { index: number }>;

export type GuardianSetAddedEventFilter = TypedEventFilter<GuardianSetAddedEvent>;
...
export type LogMessagePublishedEventFilter = TypedEventFilter<LogMessagePublishedEvent>;
...
export interface IWormhole extends BaseContract {
  ...
  getGuardianSet(index: BigNumberish, overrides?: CallOverrides): Promise<IWormhole.GuardianSetStructOutput>;
  ...
  parseVM(encodedVM: BytesLike, overrides?: CallOverrides): Promise<IWormhole.VMStructOutput>;
  ...
  filters: {
    ...
    'GuardianSetAdded(uint32)'(index?: BigNumberish | null): GuardianSetAddedEventFilter;
  ...
  estimateGas: {
    ...
    verifyVM(vm: IWormhole.VMStruct, overrides?: CallOverrides): Promise<BigNumber>;
  };
  ...
  populateTransaction: {
    ...
    verifyVM(vm: IWormhole.VMStruct, overrides?: CallOverrides): Promise<PopulatedTransaction>;
  };
}
